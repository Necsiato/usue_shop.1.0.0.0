...
import 'package:usue_app_front/views/contact_view.dart';
...
import 'package:usue_app_front/views/all_categories_view.dart';
...
GoRouter buildRouter(AuthController authController) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/catalog', builder: (context, state) => const AllCategoriesView()),
      GoRoute(
        path: '/catalog/:id',
